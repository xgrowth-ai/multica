-- Issue status catalog (MUL-6243). Each workspace holds the 8 built-in
...
-- Idempotent seed of the 8 built-ins. Safe to call concurrently from multiple
...
VALUES
    ...
    (sqlc.arg('workspace_id')::uuid, 'pending_verification', 'Pending Verification', 'Delivered, waiting on product or operations verification.', 'pending_verification', '#06b6d4', TRUE, 0),
